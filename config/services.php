...
return [
    ...
    */
    ...
    'hesabe' => [
        ...
        'checkout_endpoint' => env('HESABE_CHECKOUT_ENDPOINT', '/checkout'), // Backend API POST endpoint
        'payment_endpoint' => env('HESABE_PAYMENT_ENDPOINT', '/payment'),  // User-facing GET redirect page

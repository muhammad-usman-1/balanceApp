...
<body class="sidebar-mini layout-fixed" style="height: auto;">
    <div class="wrapper">
        <nav class="main-header navbar navbar-expand bg-white navbar-light border-bottom">
            ...
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link" id="sidebarToggle" href="#" aria-label="Toggle sidebar"><i class="fa fa-bars"></i></a>
                </li>
            </ul>
  ...
  $.fn.dataTable.ext.classes.sPageButton = '';
    ...
    (function () {
        ...
        function toggleDesktop() { document.body.classList.toggle('sb-collapsed'); }
        ...
        if (toggleBtn) {
            toggleBtn.addEventListener('click', function (e) {
                ...
                // DataTable column recalc after sidebar animation
                setTimeout(function () {
        ...
        if (sidebar) {
            sidebar.querySelectorAll('.app-sb__link:not(.app-sb__tree-trigger), .app-sb__sub-link').forEach(function (el) {
                el.addEventListener('click', function () { if (isMobile()) closeMobile(); });
            });
        }

        // Treeview accordion
        document.querySelectorAll('.app-sb__tree-trigger').forEach(function (btn) {
            btn.addEventListener('click', function (e) {
                e.preventDefault();
                this.closest('.app-sb__tree').classList.toggle('is-open');
            });
        });

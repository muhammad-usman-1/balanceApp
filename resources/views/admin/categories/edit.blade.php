...
<div class="card idx-card">
    <div class="card-header">
        <h3><i class="fas fa-pen mr-2" style="color:#b45309;"></i> Edit Category</h3>
    ...
    <div class="card-body" style="padding: 24px !important;">
        <form action="{{ route('admin.categories.update', $category->id) }}" method="POST" style="max-width:640px;">
            @csrf
            @method('PUT')
            ...
            <div class="mf-grid-2">
                <div class="mf-field">
                    ...
                    <input class="mf-input {{ $errors->has('name') ? 'is-err' : '' }}"
                           ...
                           value="{{ old('name', $category->name) }}" placeholder="e.g. Breakfast" required>
                    @if($errors->has('name'))
                ...
                <div class="mf-field">
                    ...
                    <input class="mf-input {{ $errors->has('name_ar') ? 'is-err' : '' }}"
                           ...
                           value="{{ old('name_ar', $category->name_ar) }}" placeholder="مثال: فطور">

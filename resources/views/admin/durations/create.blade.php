...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.duration.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.durations.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('no_of_weeks') ? 'is-invalid' : '' }}" type="number" name="no_of_weeks" id="no_of_weeks" value="{{ old('no_of_weeks', '') }}" step="1">

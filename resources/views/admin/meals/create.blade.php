...
<div class="card idx-card">
    <div class="card-header">
        <h3><i class="fas fa-plus-circle mr-2" style="color:#22c55e;"></i> Add New Meal</h3>
        ...
        <form method="POST" action="{{ route('admin.meals.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="mf-grid-2" style="margin-bottom:16px;">
                        ...
                        <div>
                            ...
                            <input class="mf-input {{ $errors->has('extras') ? 'is-err' : '' }}"
                                   ...
                                   value="{{ old('extras') }}" placeholder="e.g. nuts, dairy">
                    ...
                    <div class="mf-grid-4" style="margin-bottom:16px;">
                        <div>
                            ...
                            <input class="mf-input {{ $errors->has('calories') ? 'is-err' : '' }}"
                                   ...
                                   value="{{ old('calories') }}" step="1" placeholder="kcal">
                        ...
                        <div>
                            ...
                            <input class="mf-input {{ $errors->has('protein_g') ? 'is-err' : '' }}"
                                   ...
                                   value="{{ old('protein_g') }}" step="0.1" placeholder="0.0">
                        ...
                        <div>
                            ...
                            <input class="mf-input {{ $errors->has('carbs_g') ? 'is-err' : '' }}"
                                   ...
                                   value="{{ old('carbs_g') }}" step="0.1" placeholder="0.0">
                        ...
                        <div>
                            ...
                            <input class="mf-input {{ $errors->has('fat_g') ? 'is-err' : '' }}"
                                   ...
                                   value="{{ old('fat_g') }}" step="0.1" placeholder="0.0">
                            @if($errors->has('fat_g'))
                            ...
                            <div class="type-pill-wrap">
                                ...
                                <div class="type-pill">
                                    <input type="radio" id="type_{{ $key }}" name="type"
                                           value="{{ $key }}" {{ old('type', 'is meal') === $key ? 'checked' : '' }}>
                                    <label for="type_{{ $key }}">
                                        @if($key === 'is meal')
                ...
                <div>
                    ...
                    <div class="img-zone" id="img-zone">
                        ...
                        <div id="img-zone-content">
                            <i class="fas fa-cloud-upload-alt" style="font-size:2rem; color:#a5b4fc; margin-bottom:10px; display:block;"></i>
                            <div style="font-size:.82rem; font-weight:600; color:#374151;">Click to upload</div>
                            <div style="font-size:.73rem; color:#9ca3af; margin-top:4px;">PNG, JPG up to 5MB</div>
                        </div>
                    </div>
                    @if($errors->has('image'))
            ...
            <div style="margin-top: 28px; padding-top: 20px; border-top: 1px solid #f3f4f6;
                ...
                <button type="submit" class="idx-btn ib-green" style="padding: 9px 22px; font-size: .85rem;">
                    <i class="fas fa-check"></i> Save Meal
                </button>
...
(function() {
    ...
    const content = document.getElementById('img-zone-content');

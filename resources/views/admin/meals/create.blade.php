    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.meals.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('protein_g') ? 'is-invalid' : '' }}" type="number" name="protein_g" id="protein_g" value="{{ old('protein_g', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('fat_g') ? 'is-invalid' : '' }}" type="number" name="fat_g" id="fat_g" value="{{ old('fat_g', '') }}" step="0.01">
                @if($errors->has('fat_g'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('carbs_g') ? 'is-invalid' : '' }}" type="number" name="carbs_g" id="carbs_g" value="{{ old('carbs_g', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Meal::TYPE_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('type') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="type_{{ $key }}" name="type" value="{{ $key }}" {{ old('type', 'is meal') === (string) $key ? 'checked' : '' }}>

...
.mf-grid-3 { display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 16px; }
...
.stat-label { font-size: .7rem; color: #9ca3af; font-weight: 600; text-transform: uppercase; letter-spacing: .04em; }
.stat-val   { font-size: 1.1rem; font-weight: 700; color: #111827; margin-top: 1px; }
</style>

<div class="card idx-card">
    <div class="card-header">
        <h3><i class="fas fa-plus-circle mr-2" style="color:#22c55e;"></i> Add Subscription Plan</h3>
    ...
    <div class="card-body" style="padding: 24px !important;">
        <form method="POST" action="{{ route('admin.subcrption-plans.store') }}">
            @csrf
            ...
            <div class="mf-grid-2">
                <div class="mf-field">
                    ...
                    <input class="mf-input {{ $errors->has('title') ? 'is-err' : '' }}"
                           ...
                           value="{{ old('title') }}" placeholder="e.g. Standard Plan">
                    @if($errors->has('title'))
                ...
                <div class="mf-field">
                    ...
                    <input class="mf-input {{ $errors->has('title_ar') ? 'is-err' : '' }}"
                           ...
                           value="{{ old('title_ar') }}" placeholder="مثال: الخطة القياسية">
            ...
            <div class="mf-grid-2" style="margin-bottom:18px;">
                <div>
                    ...
                    <input class="mf-input {{ $errors->has('price') ? 'is-err' : '' }}"
                           ...
                           value="{{ old('price') }}" step="0.001" placeholder="0.000">
                    @if($errors->has('price'))
                ...
                <div>
                    ...
                    <input class="mf-input {{ $errors->has('no_of_weeks') ? 'is-err' : '' }}"
                           ...
                           value="{{ old('no_of_weeks') }}" min="1" step="1" placeholder="e.g. 4">
            ...
            <div class="mf-grid-2" style="margin-bottom:18px;">
                <div>
                    ...
                    <input class="mf-input {{ $errors->has('meal_count') ? 'is-err' : '' }}"
                           ...
                           value="{{ old('meal_count') }}" step="1" min="0" placeholder="e.g. 3">
                ...
                <div>
                    ...
                    <input class="mf-input {{ $errors->has('snack_count') ? 'is-err' : '' }}"
                           ...
                           value="{{ old('snack_count') }}" step="1" min="0" placeholder="e.g. 1">
            ...
            <div class="mf-grid-2" style="margin-bottom:18px;">
                <div>
                    ...
                    <input class="mf-input {{ $errors->has('min_days') ? 'is-err' : '' }}"
                           ...
                           value="{{ old('min_days') }}" min="1" max="6" step="1" placeholder="1–6">
                ...
                <div>
                    ...
                    <input class="mf-input {{ $errors->has('max_days') ? 'is-err' : '' }}"
                           ...
                           value="{{ old('max_days') }}" min="1" max="7" step="1" placeholder="1–7">
            ...
            <div style="margin-top: 28px; padding-top: 20px; border-top: 1px solid #f3f4f6;
                ...
                <button type="submit" class="idx-btn ib-green" style="padding: 9px 22px; font-size: .85rem;">
                    <i class="fas fa-check"></i> Save Plan
                </button>
